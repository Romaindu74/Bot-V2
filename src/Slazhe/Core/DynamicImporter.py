from typing import Dict, Any, Iterator, Callable, Union
...
class TypingDynamicImporter:
    def __getattr__(self, name: str) -> Union['TypingDynamicImporter', Callable[[Any], Union[Any, 'TypingDynamicImporter']]]:...
